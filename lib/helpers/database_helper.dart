...
class DatabaseHelper {
  ...
  _initDatabase() async {
    ...
    // Usara la base de xsports
    databasesPath = databasesPath.replaceFirst(
        'com.carlosvzz.sportsfilter', 'com.carlosvzz.xsports');
  ...
  Future<List<Game>> getGames(DateTime initDate, DateTime lastDate) async {
    Database db = await instance.database;
